      ...
      {carts.length === 0 ? (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            {carts.map((cart) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 w-full md:w-1/2">
                  <img src={cart.imageUrl} alt={cart.name} className="w-24 h-24 object-cover rounded-lg" />
                  <div>
          ...
          <div className="w-full lg:w-1/3 p-6  rounded-lg shadow-md bg-white">
            ...
            <button className="mt-6 w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
